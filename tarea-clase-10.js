...
function actualizarEstadoTurnoMaquina(){
    const $actualizarTurnoMaquina = document.querySelector('#div-estado');
    $actualizarTurnoMaquina.textContent = 'Es el turno de la maquina!'
    restablecerAviso();
}
function actualizarEstadoTurnoJugador(){
    const $actualizarTurnoJugador = document.querySelector('#div-estado');
    $actualizarTurnoJugador.textContent = 'Es el turno del jugador!';
    restablecerAviso();
}
